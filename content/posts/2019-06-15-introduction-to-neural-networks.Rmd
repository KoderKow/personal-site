...
slug: introduction-to-nueral-networks
categories:
  - R
  - machine learning
tags: []
...
We will start with three variables for demonstrative purposes. We fit a feed-forward neural network with one hidden layer containing two units with a linear output unit:
